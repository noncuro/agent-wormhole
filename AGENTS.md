...
agent-wormhole provides secure, encrypted ephemeral channels for AI agent instances to communicate. Think Magic Wormhole, but for Codex sessions talking to each other.
...
The skill file at `skill/SKILL.md` should be symlinked or copied into `~/.Codex/skills/agent-wormhole/SKILL.md` so Codex sessions can use `/agent-wormhole`.
